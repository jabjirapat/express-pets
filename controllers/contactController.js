...
exports.submitContact = async function (req, res, next) {
  ...
  try {
    ...
    <p>We appreciate your interest in ${doesPetExist.name} and one of our staff members will reach out to your shoryly! Below is a copy of the message you sent us for your personal records:</p>
    ...
    await Promise.all([premise1, promise2, promise3])
  } catch (err) {
    next(err)
  }
  ...
  res.send("Thanks for sending data to")
}
